...
export default function Leaderboard() {
    ...
    const [nationalAverage, setNationalAverage] = useState();
    ...
    const getData = async () => {
        ...
        setNationalAverage((signupvsScopeTotal / sortedData.length).toFixed(2));
        setData(sortedData);
        setIsLoading(false);
    }
    ...
    useEffect(() => {
        ...
        window.intervalLeaderboard = setInterval(() => getData(),15000);
