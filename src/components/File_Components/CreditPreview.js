        ...
        <>
            <Card className="m-5">
                <Card.Header>
                    ...
                    <Card.Body>
                        {showDropdown && (<DropdownMenuGroup onDpidChange={handleDpidChange} isSearch={false} />)}
                        <DataTable
                            noHeader
                            columns={headers}
                            data={data.data}
            ...
            <Modal show={show} 
                ...
                <Modal.Body className="customModalBody">
                    <CreditUpload status="BAT Modified" 
