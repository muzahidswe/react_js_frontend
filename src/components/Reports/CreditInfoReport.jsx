...
import DropdownMenuGroup from "../helper/top_dropdown_with_date_for_report";
import 'react-confirm-alert/src/react-confirm-alert.css';

const DATA_TABLE_URL = baseURL + 'credit-information'
...
function CreditInfoReport(props) {
    ...
    const getData = (dpids, routeSections, fromDate, toDate) => {
        axios.post(DATA_TABLE_URL, 
            {dpids, routeSections, fromDate, toDate, page, countPerPage}
        )
        .then(res => {
  ...
  return isLoading ? 
    (<div>
        ...
        <Card className="m-5">
            <Card.Header>
                <div className="row">
                    <h3 className="card-title">Credit Information</h3>
                </div>
