...
const DATA_TABLE_URL = baseURL + "get-kye-docs-not-uploaded";
const DATA_TABLE_DOWNLOAD_URL = baseURL + "get-kye-docs-not-uploaded-download";
...
function KycWithoutDoc(props) {
  ...
  const downloadDatas = async () => {
    ...
    await axios
      ...
      .then((res) => {
          ...
          link.setAttribute("download", 'kyc_without_doc');
          link.click();
          setIsLoading(false);
      })
      .catch((err) => {
  ...
  return (
    <Card className="m-5">
      <Card.Header>
        <h3 className="card-title">KYC Done by SS</h3>
      </Card.Header>
