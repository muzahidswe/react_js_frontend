...
const DATA_TABLE_URL = baseURL + "get-kye-docs-submitted";
const DATA_TABLE_DOWNLOAD_URL = baseURL + "get-kye-docs-submitted-download";
...
function KycDocSubmitted(props) {
  const columns = [
    {
      name: "Region",
      selector: "region",
  ...
  return isLoading ? (
    ...
    <Card className="m-5">
      <Card.Header>
        <h3 className="card-title">KYC Doc Submitted to FI</h3>
      </Card.Header>
...
export default KycDocSubmitted;
